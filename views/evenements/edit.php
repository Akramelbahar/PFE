                        ...
                        <?php if ($eventType === 'Seminaire'): ?>
                            <div class="mb-3">
                                ...
                                <input type="date" id="date" name="date"
                                       class="form-control"
                                       value="<?php echo $this->escape($specificDetails['date']); ?>"
                                       required>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" id="dateDebut" name="dateDebut"
                                           class="form-control"
                                           value="<?php echo $this->escape($specificDetails['dateDebut']); ?>"
                                           required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" id="dateFin" name="dateFin"
                                           class="form-control"
                                           value="<?php echo $this->escape($specificDetails['dateFin']); ?>"
                                           required>
                                </div>
                            </div>
                        <?php endif; ?>
                                    ...
                                    <?php foreach ($documents as $document): ?>
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <a href="<?php echo $this->url('events/download/' . $event['id'] . '/' . $document['filename']); ?>"
                                                   class="btn btn-sm btn-outline-primary me-2"
                                                   title="Télécharger">
                                                    <i class="fas fa-download"></i>
                                                </a>
                                                <a href="<?php echo $this->url('events/delete-document/' . $event['id'] . '/' . $document['filename']); ?>"
